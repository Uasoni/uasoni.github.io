...
Perhaps instead of “x is prime”, they replace it with “<span class="inline-math">$\nexists k \in \mathbb N : (1<k<x) \wedge(k|x)$</span>”. Perhaps instead of “social paradigms”, they replace it with “public idealisms of ontic metanarratives”. Every new impermeable phrase ripples the water. Every new serving of semiotic spaghetti satiates their own self-importance. That the plebian must beg for enlightenment – “what does it mean?” – the very thought only propels them up the imaginary rungs.
