...
Not sure why - figure it's something to do with the <span class="inline-math">$\omega=5\pi$</span>. Perhaps should downgrade a dimension first to check the theory is accurate: *See: [[1D TDSE Simulation]]*
