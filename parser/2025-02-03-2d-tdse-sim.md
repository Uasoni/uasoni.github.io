...
The Kronecker product is an expensive operation (by inspection <span class="inline-math">$\mathcal O(N^4)$</span>), but upon observation of the result, the 2D Laplacian (with Dirichlet boundary conditions) satisfies a very nice form (*Hint:* it [[#^1a1cb2|does not]] in fact satisfy this nice form):
